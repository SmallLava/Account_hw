...
String format = '。把以上的敘述以以下格式回傳 {"title" : (標題), "price" : (價錢), "date" : (時間 格式為yyyy-mm-dd), "isIncome" : (根據敘述 是收入則true反之false), "type" : (根據敘述決定類別,是收入則包含$income,是支出則包含$expense,只需輸出字串)}，若任何資訊缺失則在該欄位以null填入';
class GeminiService {
